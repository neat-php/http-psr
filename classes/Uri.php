...
class Uri implements UriInterface
{
     ...
     * @param NeatUrl $neat
     */
    public function __construct(NeatUrl $neat)
    {
        $this->url = $neat;
    }
    ...
    {
        $info = $this->url->username();
        if ($this->url->password()) {
            $info .= ':' . $this->url->password();
        }
    ...
    {
        $new      = clone $this;
        $new->url = $this->url->withUserInfo($user, $password);
